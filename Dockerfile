...
RUN groupadd -g 12386 globodns; useradd -m -u 12386 -g globodns -d /home/globodns globodns && \
    ...
    && yum -y install libyaml sudo bind9 libyaml-devel readline-devel ncurses-devel gdbm-devel tcl-devel openssl-devel db4-devel libffi-devel which gpg gcc gcc-c++ make bind-utils bind9 \
